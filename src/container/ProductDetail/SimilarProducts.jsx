...
import { Grid, Typography, CardMedia, Card, CardContent, CardActionArea } from "@mui/material";
...
const SimilarProducts = ({ pId, setIsLoading }) => {
    ...
    useEffect(() => {
        if (!similarProductDetailedData || similarProductDetailedData.length === 0) {
            setIsLoading(true);
    ...
    const finalData = similarProductDetailedData && similarProductDetailedData || [];
    ...
    return (
        ...
        <div className=" " style={{ padding: "0px 65px 0px", marginBottom: '40px' }}>
            <Container fluid>
                <Row className="m-0 p-0">
                    ...
                    <Col md={12}>
                        <Slider  {...settings}>
                            {finalData && finalData?.map((elem, index) => (
                                <div key={elem?._id}
                                    className="banner_img zoomin-img-hover"
                                    style={{ padding: "10px 8px", display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}
                                >
                                    <Link to={`/product-detail/${elem?._id}`}>
                                     ...
                                     //       onClick={() => onCardClick(elem)}
                                        ...
                                        >
                                            ...
                                            <Card sx={{ width: "250px", borderRadius: "20px", height: 'auto' }}>
                                                <CardActionArea>
                                                    <CardMedia
                                                        className="not"
                                                        component="img"
