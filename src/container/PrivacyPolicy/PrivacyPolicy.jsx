...
const useStyles = makeStyles((theme) => ({
  ...
  privacyPolicyContent: {
    fontSize: theme.breakpoints.down("sm") ? "1rem" : "2rem",
    fontWeight: "500",
  },
}));
          ...
          <Col className={classes.privacyPolicyContent}>
            <div className="columns">
              ...
              <div className="content-design">
                ...
                <h6 className={classes.privacyPolicyHeading}>Definitions</h6>
                <p>
                ...
                <ul>
                  ...
                  <li><p><strong>&#8226; Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to WEBGROSS SOLUTIONS PRIVATE LIMITED, 319, Aggarwal Millennium Tower-1, Netaji Subhash Place, Pitampura, New Delhi 110034.</p></li>
                  ...
                  <li><p><strong>&#8226; Website</strong> refers to Vibezter, accessible from <a href={"http://vibezter.com"}><span style={{ color: "blue" }}>https://vibezter.com.</span></a></p></li>
                ...
                <h6 className={classes.privacyPolicyHeading}>
                  Personal Data
                </h6>
                <p>
                ...
                <h6 className={classes.privacyPolicyHeading}>Information from Third-Party Social Media Services</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Tracking Technologies and Cookies</h6>
                ...
                <ul>
                  ...
                  <li><p>Type: Persistent Cookies</p>
                  </li>
                  <li>
                    <p>Administered by: Us</p>
                  </li>
                ...
                <h6 className={classes.privacyPolicyHeading}>Use of Your Personal Data</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Retention of Your Personal Data</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Transfer of Your Personal Data</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Delete Your Personal Data</h6>
                ...
                <h6 className={classes.privacyPolicyTitle}>Disclosure of Your Personal Data</h6>


                <h6 className={classes.privacyPolicyHeading}>Business Transactions</h6>

                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

                <h6 className={classes.privacyPolicyHeading}>Law enforcement</h6>

                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>



                <h6 className={classes.privacyPolicyHeading}>Other legal requirements</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Security of Your Personal Data</h6>

                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>

                <h6 className={classes.privacyPolicyHeading}>Children's Privacy</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Links to Other Websites</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Changes to this Privacy Policy</h6>
                ...
                <h6 className={classes.privacyPolicyHeading}>Contact Us</h6>
                <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                <ul>
                  <li>&#8226; By visiting this page on our website: <a href="http://vibezter.com/contact-us"><span style={{ color: "blue" }}>http://vibezter.com/contact-us.</span></a></li>
                </ul>
              </div>
            </div>
          </Col>
