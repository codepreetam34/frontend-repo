...
export const addHomepageTwoAdsBanner = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      const response = await axiosInstance.post(`api/bannerTwoAds/create`, payload);
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue({ error: error });
    }
...
export const editHomepageTwoAdsBanner = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      const response = await axiosInstance.patch(`api/bannerTwoAds/update`, payload);
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue({ error: error });
    }
...
export const deleteHomepageTwoAdsBanner = createAsyncThunk(
  ...
  async (bannerId, thunkAPI) => {
    try {
      const response = await axiosInstance.post(`api/bannerTwoAds/delete`, bannerId);
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue({ error: error });
    }
